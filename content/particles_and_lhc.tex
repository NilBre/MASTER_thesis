...
% here talk more about the upgrade and why we need it and why it is a good design

% \begin{figure}
%   \centering
%   \includegraphics{plots/forwardbbar.png}
...
%   \caption{A Sideview of the SciFi Tracker.}
%   \label{fig:scifi}
% \end{figure}
